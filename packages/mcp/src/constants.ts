...
export const SERVER_INSTRUCTIONS =
  ...
  "combine allow_out (including the DNS resolvers '1.1.1.1/32' and '8.8.8.8/32') with deny_out:['0.0.0.0/0']; audit HTTP/HTTPS egress with sandbox_network_log. Publish a listening " +
